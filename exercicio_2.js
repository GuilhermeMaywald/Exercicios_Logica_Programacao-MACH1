// 2 - Desenvolva uma função que recebe dois parâmetros, um é a quantidade de horas
...
function calcularSalario(numeroHoras, valorHoras) {
    return `Salário igual a R$ ${numeroHoras * valorHoras}`;
}
console.log(calcularSalario(100, 75));